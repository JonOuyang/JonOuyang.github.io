...
const PublicHomeWithBackground = () => {
  return (
    <main className="bg-black text-white min-h-screen flex flex-col items-center justify-center px-6 py-16 relative">

      {/* Background Image with Aggressive Fade */}
      <div
        className="absolute inset-0 z-0"
        style={{
          backgroundImage: 'url(/assets/newyork.JPG)',
          backgroundSize: 'cover',
          backgroundPosition: 'center',
          backgroundRepeat: 'no-repeat'
        }}
      >
        {/* Aggressive gradient overlay - fades bottom 50% to black */}
        <div
          className="absolute inset-0"
          style={{
            background: 'linear-gradient(to bottom, transparent 0%, transparent 50%, rgba(0,0,0,0.5) 55%, rgba(0,0,0,0.85) 65%, rgba(0,0,0,0.98) 80%, black 100%)'
          }}
        />
      </div>
...
export default PublicHomeWithBackground;
